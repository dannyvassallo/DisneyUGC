  ...
  describe '#create' do
    ...
    it "Of age anon attempts to create a post with just a video" do
      ...
      post :create, campaign_id: @campaign.slug, post:{
        ...
        email_address: Faker::Internet.email,
        image_url: nil,
        video_url: Rack::Test::UploadedFile.new(File.open(File.expand_path('../../spec/fixtures/files/8450DACAD21274209265779081216_SW_WEBM_1446769221867227cf9729c.mp4', File.dirname(__FILE__)))),
        video_url_processing: false,
        image_url_processing: false
      }
      @post = Post.last
